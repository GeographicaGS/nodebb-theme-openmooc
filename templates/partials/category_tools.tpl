...
<div class="dropdown thread-tools">
	<button class="btn dropdown-toggle" data-toggle="dropdown" type="button">[[topic:thread_tools.title]] <span class="caret"></span></button>
